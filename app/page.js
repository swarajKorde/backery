...
export default function Home() {
  return (
    <div className="bg-prime min-h-screen w-screen flex flex-col items-center gap-6 md:gap-8">

      {/* Hero Layout (Left + Right Section) */}
      <div className="w-full flex flex-col md:flex-row justify-center md:justify-evenly items-start md:items-center gap-6 md:gap-4 lg:gap-8 px-2 md:p-4">
        ...
        {/* Right Column */}
        <div className="hidden md:flex md:w-1/3 lg:w-1/4 justify-center md:justify-start">
          <RightComponent />
        </div>
      </div>

      {/* ✅ Product section BELOW everything */}
